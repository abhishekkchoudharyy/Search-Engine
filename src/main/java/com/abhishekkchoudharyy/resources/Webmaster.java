package com.abhishekkchoudharyy.resources;

import com.abhishekkchoudharyy.core.Crawler;
...
@Path("/")
@Tag(name = "Webmaster Apis", description = "Use the Api to Crawl Website to make it index it")
...
public class Webmaster {
    ...
    public Response crawl(@NonNull @QueryParam("url") final String url,
        ...
        try{
            ...
            crawler.crawl(url,crawlChildren,0);
